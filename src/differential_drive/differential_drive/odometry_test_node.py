...
class OdometryTestNode(Node):
    ...
    def joy_callback(self, msg: Joy):
        ...
        # Note: Button mapping can vary. buttons[0] is typically 'A' on Xbox/Logitech controllers.
        if msg.buttons[0] == 1 and self.state == 'IDLE':
            self.get_logger().info('Button pressed. Starting 1-meter forward test...')
            self.state = 'MOVING'
