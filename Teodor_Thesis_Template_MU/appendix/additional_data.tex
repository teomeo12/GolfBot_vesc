...
\begin{figure}[h!]
    ...
    % The short caption goes in the [], the long caption in the {}
...
% SECTION 7: Referenced from Section 5.1
...
\begin{figure}[h!]
    \centering
    % Subfigure for the Bounding Box F1 Curve
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/BoxF1_curve.png} 
        \caption{Detection (Box).} % The caption for the subfigure itself
        \label{fig:box_f1_appendix}
    \end{subfigure}
    \hfill 
    % Subfigure for the Segmentation Mask F1 Curve
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
