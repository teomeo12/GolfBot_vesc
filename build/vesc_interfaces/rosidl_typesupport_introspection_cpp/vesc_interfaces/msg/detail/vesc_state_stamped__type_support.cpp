...
{
  new (message_memory) vesc_interfaces::msg::VescStateStamped(_init);
}

void VescStateStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vesc_interfaces::msg::VescStateStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VescStateStamped_message_member_array[2] = {
  {
    ...
    offsetof(vesc_interfaces::msg::VescStateStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<vesc_interfaces::msg::VescState>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(vesc_interfaces::msg::VescStateStamped, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VescStateStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(vesc_interfaces::msg::VescStateStamped),
...
{
  return &::vesc_interfaces::msg::rosidl_typesupport_introspection_cpp::VescStateStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vesc_interfaces, msg, VescStateStamped)() {
  return &::vesc_interfaces::msg::rosidl_typesupport_introspection_cpp::VescStateStamped_message_type_support_handle;
}
