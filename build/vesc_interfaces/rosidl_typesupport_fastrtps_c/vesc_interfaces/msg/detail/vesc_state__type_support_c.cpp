...
#include "vesc_interfaces/msg/detail/vesc_state__rosidl_typesupport_fastrtps_c.h"
...
using _VescState__ros_msg_type = vesc_interfaces__msg__VescState;
...
static uint32_t _VescState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vesc_interfaces__msg__VescState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vesc_interfaces__msg__VescState;
    is_plain =
      (
...
static size_t _VescState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vesc_interfaces__msg__VescState(
