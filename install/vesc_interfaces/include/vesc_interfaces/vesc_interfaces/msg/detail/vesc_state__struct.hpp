...
#ifndef VESC_INTERFACES__MSG__DETAIL__VESC_STATE__STRUCT_HPP_
#define VESC_INTERFACES__MSG__DETAIL__VESC_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__vesc_interfaces__msg__VescState __attribute__((deprecated))
#else
# define DEPRECATED__vesc_interfaces__msg__VescState __declspec(deprecated)
#endif
...
struct VescState_
{
  ...
  using ConstRawPtr =
    const vesc_interfaces::msg::VescState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<vesc_interfaces::msg::VescState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<vesc_interfaces::msg::VescState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      vesc_interfaces::msg::VescState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<vesc_interfaces::msg::VescState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<vesc_interfaces::msg::VescState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<vesc_interfaces::msg::VescState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<vesc_interfaces::msg::VescState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__vesc_interfaces__msg__VescState
    std::shared_ptr<vesc_interfaces::msg::VescState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__vesc_interfaces__msg__VescState
    std::shared_ptr<vesc_interfaces::msg::VescState_<ContainerAllocator> const>
...
using VescState =
  vesc_interfaces::msg::VescState_<std::allocator<void>>;
...
#endif  // VESC_INTERFACES__MSG__DETAIL__VESC_STATE__STRUCT_HPP_
