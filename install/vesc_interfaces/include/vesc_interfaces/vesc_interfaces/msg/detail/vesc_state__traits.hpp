...
#ifndef VESC_INTERFACES__MSG__DETAIL__VESC_STATE__TRAITS_HPP_
#define VESC_INTERFACES__MSG__DETAIL__VESC_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const vesc_interfaces::msg::VescState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const vesc_interfaces::msg::VescState & msg)
{
  return vesc_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<vesc_interfaces::msg::VescState>()
{
  return "vesc_interfaces::msg::VescState";
}

template<>
inline const char * name<vesc_interfaces::msg::VescState>()
{
  return "vesc_interfaces/msg/VescState";
}

template<>
struct has_fixed_size<vesc_interfaces::msg::VescState>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<vesc_interfaces::msg::VescState>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<vesc_interfaces::msg::VescState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // VESC_INTERFACES__MSG__DETAIL__VESC_STATE__TRAITS_HPP_
