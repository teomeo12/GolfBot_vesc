...
bool vesc_interfaces__msg__vesc_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vesc_interfaces.msg._vesc_state.VescState", full_classname_dest, 41) == 0);
  }
  vesc_interfaces__msg__VescState * ros_message = _ros_message;
  {  // temp_fet
...
PyObject * vesc_interfaces__msg__vesc_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vesc_interfaces.msg._vesc_state");
